...
| `rules`                  |           RuleItem[]           |        []         | Array of [Rule Items](/concepts/elements.html#rule-item) - must be valid [Laravel Validations](https://laravel.com/docs/10.x/validation#available-validation-rules) |
...
| `tooltip`                |       Tooltip, undefined       |     undefined     | [Tooltip] (/concepts/elements.html#tooltips)                                                                                                                        |
...
| Property    |    Type     |   Default   | Description                                                              |
|:------------|:-----------:|:-----------:|:-------------------------------------------------------------------------|
| `menu`      |    Menu     |    Menu     | Style and display a [Menu](/concepts/elements.html#menu) for the picker. |
...
| Property   |        Type        |  Default  | Description                                                         |
|:-----------|:------------------:|:---------:|:--------------------------------------------------------------------|
| `items`    |    SelectItem[]    |    []     | Array of [Select Items](/concepts/elements.html#select-item)        |
| `loadable` | Closure, undefined | undefined | Provide a closure that will be run when a field needs to be loaded. |
